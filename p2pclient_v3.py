...
def format_get_request(rfc_number):
...
def lookup(client_socket):
    rfc_number = input("Please enter the RFC number you try to look up\n")
...
def download_rfc():
    ...
    try:
        ...
        msg = format_get_request(rfc_number)
